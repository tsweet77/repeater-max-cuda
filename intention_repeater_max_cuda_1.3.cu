/*
    Intention Repeater MAX CUDA v1.3 created by Thomas Sweet.
...
int main(int argc, char ** argv) {
    ...
    cout << "Intention Repeater MAX CUDA v1.3 created by Thomas Sweet." << endl;
    ...
    std::cout << "[" + runtime_formatted + "]" << " (" << suffix(iterations) << "/" << suffix_hz(int(iterations/seconds)) << "Hz): " << intention << "     " << endl << std::flush;

...
IRM = "Intention_Repeater_MAX_CUDA.exe"
...
class IntentionRepeaterGUI:
    def disable_widgets(self):
        ...
        widget_variable_names = [
            ...
            'timer_var', 'rest_for_entry', 'run_button', 'holo_link_button',
            ...
            'duration_entry', 'timer_dropdown', 'color_var', 'file2_label',
    ...
    def on_run_clicked(self):
        ...
        # Your existing code to launch IRM = "Intention_Repeater_MAX_CUDA.exe" goes here
